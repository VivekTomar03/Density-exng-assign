        ...
        <Box w="90%" m="auto" mt="100px" bg="#f3f1ff" boxShadow="lg" borderRadius="xl" padding={"20px"}>
            <Flex gap="30px" p="20px">
                ...
                <Flex flexDirection="column" gap="10px">
                    ...
                    <SimpleGrid height="400px" bg="white" p="10px" borderRadius="md" boxShadow="md" color="blue.500" scrollbarColor="blue.500" scrollbarWidth="thin" className='scrolling' overflowY={"scroll"} gap={"25px"}>
